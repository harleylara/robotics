...
<Drawio file="mavlink.drawio">
    Conceptual overview of the different parts of MAVLink as a project and not just as a protocol.
</Drawio>
...
<Drawio file="mavlink.drawio" page="3">
    General concept in MAVLink Networks.
</Drawio>
...
<Drawio file="mavlink.drawio" page="2">
    MAVLink packet frame structure and comparison.
</Drawio>
