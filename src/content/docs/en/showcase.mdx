...
- [`remark-capitalize-headings`](https://github.com/Xunnamius/unified-utils/tree/main/packages/remark-capitalize-headings): Header are automaticaly adjusted to adheres to [The Chicago Manual of Style](https://en.wikipedia.org/wiki/The_Chicago_Manual_of_Style).
