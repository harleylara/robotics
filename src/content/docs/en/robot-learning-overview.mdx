...
<Drawio
    file="robot-learning.drawio"
    page="1"
    description="Just a view of the field of robot learning."
/>
...
<Think
    note="Building robots is hard, and making them *'learn'* is even more difficult. If we have not yet mastered the art of building robots, how can we even think of teaching them?"
/>
...
<Drawio
    file="robot-learning.drawio"
    page="2"
    description="Dealing with imperfect information."
/>
...
<Definition
    term="Robot Learning Problem"
    definition="Generally speaking, the robot learning problem is to infer a mapping from sensors/states to actions given a training sequence of sensory inputs, action outputs, and feedback values."
    source="Robot Learning by Jonathan H. Connell and Sridhar Mahadevan"
    link="https://link.springer.com/book/10.1007/978-1-4615-3184-5"
/>

<Equation
    formula="\pi: S \rightarrow A"
    description="Basic idea of robot learning"
/>

<Drawio
    file="robot-learning.drawio"
    page="4"
    description="States maps to actions"
/>
...
<Think
    note="Where do these sequences (states and actions) come from?"
/>
...
<Important
    note="Whether for a human or a robot, performance feedback is essential for learning."
/>
