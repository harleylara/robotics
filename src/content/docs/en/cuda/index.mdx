...
Normally you need to install more then just CUDA, so NVIDIA offers something called "CUDA Toolkit" (recommend), there are 3-ways to install the CUDA Toolkit:
- local deb
- network deb (recommend): allow to get updates and patches over apt
- runfile (please do not use this): this is a very invasy way to install the toolkit and it would overwrite OS libraries
...
<Definition term="Compute Capabilities">
Set of specifications and features of a compute device depend on.

Source: [CUDA C Programming Guide](https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html#compute-capabilities)
</Definition>
...
- [CUDA: Pointers on the GPU](https://www.cs.uaf.edu/2010/fall/cs441/lecture/12_02_CUDA.html), CS 441 Lecture, Dr. Lawlor
