...
```c filename="hello.c" remoteURL="https://raw.githubusercontent.com/harleylara/cpp-intro/refs/heads/master/elf/hello.c"
```
...
<Drawio file="elf.drawio" page="1">
    Object File Format, source: Figure 1.1 Specification.
</Drawio>
...
- [ELF for the Arm® Architecture - aaelf32](https://github.com/ARM-software/abi-aa/releases/download/2025Q4/aaelf32.pdf). [Application Binary Interface for the Arm - Github Repo](https://github.com/ARM-software/abi-aa?tab=readme-ov-file).

https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://kolegite.com/EE_library/standards/ARM_ABI/aaelf32.pdf&ved=2ahUKEwiowq-ZndeTAxVdQvEDHXmCOBYQFnoECAwQAQ&usg=AOvVaw1geqaRQj4UcoPjLyyMDiWw
