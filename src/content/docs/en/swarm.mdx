...
<Definition term="Swarm Robotics">
Swarm robotics is the study of how to make robots collaborate to collectively solve a task, that would otherwise be impossible to solve by a single individual of these robots.
</Definition>
...
<Definition>
    $10^{2} < \textrm{N} \ll 10^{23}$

    Plausible range for a swarm system.
</Definition>

<Definition term="Swarm Robotics">
"Is the study of how a large number of 'relatively simple' physically embodied agents can be designed such that a desited collective behavior emerges."
</Definition>
