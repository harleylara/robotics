...
- OS: Ubuntu 22.04 Desktop. I personally recommend a native Ubuntu installation on your computers. Dual-boot also works but very impractical for daily use (in my opinion). If you want to use a virtual machine I recommend using VMWare Player it's free for personal non-commercial use (runs on GNU/Linux and Windows).
