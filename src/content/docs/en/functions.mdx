...
<Equation>
    $$
    \forall x \in \sX, \quad \exist ! y \in \sY \quad \textrm{such that } (x,y) \in f
    $$
    Let $\sX$, $\sY$ be sets. Let $f$ be a relation between $\sX$ and $\sY$, so $f ⊆ \sX \times \sY$.
</Equation>
...
<Drawio file="functions.drawio" page="1">
    Visual intuition of a function.
</Drawio>
...
<FunctionMappingSimple>
    Mapping/relation from domain to codomain with a relation described as $x^2$.
</FunctionMappingSimple>
...
<Equation>
    $$
    f: \sR \rightarrow \sR_{\ge 0}, \quad f(x) = x^2
    $$
</Equation>
...
<Equation>
    ...
    f: \sX \rightarrow \sY
    $$
    A function is just a mapping.
</Equation>

We can generalize this idea to sets.

<Drawio file="functions.drawio" page="1">
    Visual intuition of a function on sets.
</Drawio>
...
<Drawio file="functions.drawio" page="2">
    Visual intuition of a function applied in reverse mapping.
</Drawio>
