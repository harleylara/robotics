...
As you can see this representation is a bit difficult to interpret, so it is common to represent it as follows, where the horizontal axis is the domain and the vertial axis is the codomain.
