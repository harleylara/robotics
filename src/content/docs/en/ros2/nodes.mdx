...
Update Oct. 2025: [--symlink-install breaks for setuptools >= 80.0.0 #696](https://github.com/colcon/colcon-core/issues/696) and [Declare incompatibility with setuptools >= 80 #699](https://github.com/colcon/colcon-core/pull/699). For a quick-fix use:
