...
Example how to install a ros2-variants. But in reallity you need to do more things as describe in the official documentation, e.g. [Ubuntu (deb packages)](https://docs.ros.org/en/humble/Installation/Ubuntu-Install-Debs.html)
```plain
