...
```python filename="qos/pub.py" remoteURL="https://raw.githubusercontent.com/harleylara/ros2-intro/master/python_basics/python_basics/qos/pub.py"
```

Subscriber QoS demo:

```python filename="qos/sub.py" remoteURL="https://raw.githubusercontent.com/harleylara/ros2-intro/master/python_basics/python_basics/qos/sub.py"
```

## Transient Local

```python filename="qos/latched_pub.py" remoteURL="https://raw.githubusercontent.com/harleylara/ros2-intro/master/python_basics/python_basics/qos/latched_pub.py"
```
