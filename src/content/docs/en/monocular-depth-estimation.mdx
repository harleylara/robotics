...
|------------|--------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| (2005)     |              | [Learning Depth from Single Monocular Images](https://papers.nips.cc/paper_files/paper/2005/file/17d8da815fa21c57af9829fb0a869602-Paper.pdf)                                                                         | [ref in: @vandijkHowNeuralNetworks2019]                                                                      |
| (Jun 2014) |              | @eigenDepthMapPrediction2014 [Depth Map Prediction from a Single Image using a Multi-Scale Deep Network](https://arxiv.org/pdf/1406.2283)                                                                            | [ref in: @bhoiMonocularDepthEstimation2019, @zhaoMonocularDepthEstimation2020, @eigenDepthMapPrediction2014] |
...
| (Jul 2016) |              | [Unsupervised CNN for Single View Depth Estimation: Geometry to the Rescue](https://arxiv.org/pdf/1603.04992) (CNN)                                                                                                  | [ref in: @zhaoMonocularDepthEstimation2020, @vandijkHowNeuralNetworks2019]                                   |
...
| (Apr 2017) | MonoDepth V1 | [Unsupervised Monocular Depth Estimation with Left-Right Consistency](https://arxiv.org/pdf/1609.03677)                                                                                                              | [ref in: @zhaoMonocularDepthEstimation2020, @vandijkHowNeuralNetworks2019]                                   |
...
| (Aug 2017) | SfMLearner   | [Unsupervised Learning of Depth and Ego-Motion from Video](https://arxiv.org/pdf/1704.07813)                                                                                                                         | [ref in: @zhaoMonocularDepthEstimation2020, @vandijkHowNeuralNetworks2019]                                   |
...
| (Dec 2017) | LKVOLearner  | [Learning Depth from Monocular Videos using Direct Methods](https://arxiv.org/pdf/1712.00175)                                                                                                                        | [ref in: @vandijkHowNeuralNetworks2019]                                                                      |
| (May 2017) | Semodepth    | [Semi-Supervised Deep Learning for Monocular Depth Map Prediction](https://arxiv.org/pdf/1702.02706)                                                                                                                 | [ref in: @vandijkHowNeuralNetworks2019]                                                                      |
...
- (Nov 2021) [Towards Real-Time Monocular Depth Estimation for Robotics: A Survey](https://arxiv.org/pdf/2111.08600)
