...
<Drawio file="aima-03.drawio" page="1">
    Acyclic and Cyclic graphs.
</Drawio>

<Drawio file="aima-03.drawio" page="2">
...
<Drawio file="aima-03.drawio" page="6">
   Breadth-first search example.
</Drawio>

### Dijkstra's algorithm and Uniformed Search

<Drawio file="aima-03.drawio" page="5">
...
<Equation>
    ...
    h(n)
    $$
    **Heuristic function**: estimated cost of the **cheapest path** from the state at node `n` to a goal state.
</Equation>
...
<Drawio file="aima-03.drawio" page="3">
    A* search example.
</Drawio>
